...
tf.flags.DEFINE_string("annotation_file", "/home/mxy/json_data/annotations_train.json",
                       "Annotation file name.")
tf.flags.DEFINE_string("dataset_path", "/home/mxy/json_data/sg_dataset/sg_train_images",
...
def main(_):
    ...
    top1_correct = 0
    num_total_rel = 0
    classifier = cPickle.load(open(FLAGS.visual_checkpoint_file, "r"))
    with tf.Session() as sess:
        ...
        for ind, (img_fname, ann) in enumerate(annotations.iteritems()):
            ...
            def get_pred(obj1, obj2):
                ...
                v_predictions = post_process_vscore(np.squeeze(classifier.predict_proba(np.array([[obj1.category, obj2.category] + list(obj1.bbox) + list(obj2.bbox)]))))
